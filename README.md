...
Alternatively, the user can provide the flanking sequence can the barcode length manually like below:
...
To save the images generated by the functions above, a user can pass a value (path and name of the file where to save) to the `save_name` parameter.
